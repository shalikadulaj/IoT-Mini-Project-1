 ...
 *
 * @brief SD Host Controller Interface Declaration
 *
 * @note This file is extracted from the Atmel SAME54 Series Device Support
 *       Package (1.1.134) http://packs.download.atmel.com/ and slighlty
 *       modified to be compliant with the SD Host Controller Simplified
 *       Specification, Version 3.00 [[sdcard.org](https://www.sdcard.org)].
 *
 */

#ifndef VENDOR_SDHC_H
#define VENDOR_SDHC_H

#if !DOXYGEN    /* hide implementation details */

/* SAM0 defines REV_SDHC. In that case following register types are defined by
 * the Atmel SAM D5x/E5x Series Device Support Package and must not be
 * redefined */
#ifndef REV_SDHC
...
typedef union {
  struct {
    uint16_t BLOCKSIZE:12;     /*!< bit:  0..11  Transfer Block Size                */
...
#define SDHC_BSR_BLOCKSIZE_Msk      (_U_(0xFFF) << SDHC_BSR_BLOCKSIZE_Pos)
...
typedef union {
  struct {
    ...
    uint8_t  EXTDW:1;          /*!< bit:      5  Extended Data Transfer Width       */
...
#define SDHC_HC1R_EXTDW_Pos         5            /**< \brief (SDHC_HC1R) Extended Data Transfer Width */
#define SDHC_HC1R_EXTDW             (_U_(0x1) << SDHC_HC1R_EXTDW_Pos)
#define   SDHC_HC1R_EXTDW_NO_Val        _U_(0x0)   /**< \brief (SDHC_HC1R) No Extended Data Transfer Width */
#define   SDHC_HC1R_EXTDW_YES_Val       _U_(0x1)   /**< \brief (SDHC_HC1R) Extended Data Transfer Width */
#define SDHC_HC1R_EXTDW_NO          (SDHC_HC1R_EXTDW_NO_Val        << SDHC_HC1R_EXTDW_Pos)
#define SDHC_HC1R_EXTDW_YES         (SDHC_HC1R_EXTDW_YES_Val       << SDHC_HC1R_EXTDW_Pos)
...
typedef union {
  struct {
    ...
    uint16_t :3;               /*!< bit:  9..11  Reserved (INT_A, INT_B, INT_C)     */
    uint16_t RTEV:1;           /*!< bit:     12  Re-Tuning Event                    */
...
#define SDHC_NISTR_RTEV_Pos         12           /**< \brief (SDHC_NISTR) Re-Tuning Event */
#define SDHC_NISTR_RTEV             (_U_(0x1) << SDHC_NISTR_RTEV_Pos)
#define   SDHC_NISTR_RTEV_NO_Val          _U_(0x0)   /**< \brief (SDHC_NISTR) No Re-Tuning Event */
#define   SDHC_NISTR_RTEV_YES_Val         _U_(0x1)   /**< \brief (SDHC_NISTR) Generate Re-Tuning Event */
#define SDHC_NISTR_RTEV_NO          (SDHC_NISTR_RTEV_NO_Val        << SDHC_NISTR_RTEV_Pos)
#define SDHC_NISTR_RTEV_YES         (SDHC_NISTR_RTEV_YES_Val       << SDHC_NISTR_RTEV_Pos)
...
#define SDHC_NISTR_MASK             _U_(0x91FF)  /**< \brief (SDHC_NISTR) MASK Register */
...
typedef union {
  struct {
    ...
    uint16_t TUNE:1;           /*!< bit:     10  Tuning Error                       */
...
#define SDHC_EISTR_TUNE_Pos         10           /**< \brief (SDHC_EISTR) Tuning Error */
#define SDHC_EISTR_TUNE             (_U_(0x1) << SDHC_EISTR_TUNE_Pos)
#define   SDHC_EISTR_TUNE_NO_Val          _U_(0x0)   /**< \brief (SDHC_EISTR) No Error */
#define   SDHC_EISTR_TUNE_YES_Val         _U_(0x1)   /**< \brief (SDHC_EISTR) Error */
#define SDHC_EISTR_TUNE_NO          (SDHC_EISTR_TUNE_NO_Val        << SDHC_EISTR_TUNE_Pos)
#define SDHC_EISTR_TUNE_YES         (SDHC_EISTR_TUNE_YES_Val       << SDHC_EISTR_TUNE_Pos)
#define SDHC_EISTR_MASK             _U_(0x07FF)  /**< \brief (SDHC_EISTR) MASK Register */
...
#define SDHC_NISTER_RTEV_Pos        12           /**< \brief (SDHC_NISTER) Re-Tuning Event */
#define SDHC_NISTER_RTEV            (_U_(0x1) << SDHC_NISTER_RTEV_Pos)
#define   SDHC_NISTER_RTEV_MASKED_Val     _U_(0x0)   /**< \brief (SDHC_NISTER) Masked */
#define   SDHC_NISTER_RTEV_ENABLED_Val    _U_(0x1)   /**< \brief (SDHC_NISTER) Enabled */
#define SDHC_NISTER_RTEV_NO         (SDHC_NISTER_RTEV_MASKED_Val   << SDHC_NISTER_RTEV_Pos)
#define SDHC_NISTER_RTEV_YES        (SDHC_NISTER_RTEV_ENABLED_Val  << SDHC_NISTER_RTEV_Pos)
#define SDHC_NISTER_MASK            _U_(0x11FF)  /**< \brief (SDHC_NISTER) MASK Register */
...
typedef union {
  struct {
    ...
    uint16_t TUNE:1;           /*!< bit:     10  Tuning Error Status Enable         */
    uint16_t :5;               /*!< bit: 11..15  Reserved                           */
  } bit;                       /*!< Structure used for bit  access                  */
  struct { // EMMC mode
    uint16_t CMDTEO:1;         /*!< bit:      0  Command Timeout Error Status Enable */
...
#define SDHC_EISTER_TUNE_Pos         10           /**< \brief (SDHC_EISTER) Tuning Error */
#define SDHC_EISTER_TUNE             (_U_(0x1) << SDHC_EISTER_TUNE_Pos)
#define   SDHC_EISTER_TUNE_MASKED_Val     _U_(0x0)   /**< \brief (SDHC_EISTER) Masked */
#define   SDHC_EISTER_TUNE_ENABLED_Val    _U_(0x1)   /**< \brief (SDHC_EISTER) Enabled */
#define SDHC_EISTER_TUNE_MASKED      (SDHC_EISTER_TUNE_MASKED_Val  << SDHC_EISTER_TUNE_Pos)
#define SDHC_EISTER_TUNE_ENABLED     (SDHC_EISTER_TUNE_ENABLED_Val << SDHC_EISTER_TUNE_Pos)
#define SDHC_EISTER_MASK            _U_(0x07FF)  /**< \brief (SDHC_EISTER) MASK Register */
...
typedef union {
  struct {
    ...
    uint16_t :3;               /*!< bit:  9..11  Reserved (INT_A, INT_B, INT_C)     */
    uint16_t RTEV:1;           /*!< bit:     12  Re-Tuning Event Signal Enable      */
    uint16_t :3;               /*!< bit: 13..15  Reserved                           */
  } bit;                       /*!< Structure used for bit  access                  */
  struct { // EMMC mode
    uint16_t CMDC:1;           /*!< bit:      0  Command Complete Signal Enable     */
...
#define SDHC_NISIER_RTEV_Pos        12           /**< \brief (SDHC_NISIER) Re-Tuning Event Signal Enable */
#define SDHC_NISIER_RTEV            (_U_(0x1) << SDHC_NISIER_RTEV_Pos)
#define   SDHC_NISIER_RTEV_MASKED_Val     _U_(0x0)   /**< \brief (SDHC_NISIER) Masked */
#define   SDHC_NISIER_RTEV_ENABLED_Val    _U_(0x1)   /**< \brief (SDHC_NISIER) Enabled */
#define SDHC_NISIER_RTEV_NO         (SDHC_NISIER_RTEV_MASKED_Val   << SDHC_NISIER_RTEV_Pos)
#define SDHC_NISIER_RTEV_YES        (SDHC_NISIER_RTEV_ENABLED_Val  << SDHC_NISIER_RTEV_Pos)
#define SDHC_NISIER_MASK            _U_(0x11FF)  /**< \brief (SDHC_NISIER) MASK Register */
...
typedef union {
  struct {
    ...
    uint16_t TUNE:1;           /*!< bit:     10  Tuning Error Signal Enable         */
    uint16_t :5;               /*!< bit: 11..15  Reserved                           */
  } bit;                       /*!< Structure used for bit  access                  */
  struct { // EMMC mode
    uint16_t CMDTEO:1;         /*!< bit:      0  Command Timeout Error Signal Enable */
...
#define SDHC_EISIER_TUNE_Pos         10           /**< \brief (SDHC_EISIER) Tuning Error Signal Enable */
#define SDHC_EISIER_TUNE             (_U_(0x1) << SDHC_EISTER_TUNE_Pos)
#define   SDHC_EISIER_TUNE_MASKED_Val     _U_(0x0)   /**< \brief (SDHC_EISIER) Masked */
#define   SDHC_EISIER_TUNE_ENABLED_Val    _U_(0x1)   /**< \brief (SDHC_EISIER) Enabled */
#define SDHC_EISIER_TUNE_MASKED      (SDHC_EISIER_TUNE_MASKED_Val  << SDHC_EISTER_TUNE_Pos)
#define SDHC_EISIER_TUNE_ENABLED     (SDHC_EISIER_TUNE_ENABLED_Val << SDHC_EISTER_TUNE_Pos)
#define SDHC_EISIER_MASK            _U_(0x07FF)  /**< \brief (SDHC_EISIER) MASK Register */
